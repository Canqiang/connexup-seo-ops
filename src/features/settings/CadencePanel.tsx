  ...
  return <section aria-labelledby="cadence-heading" className="settings-section data-panel">
    ...
    {!resource.loading && !resource.error && form ? <>
      ...
      <div className="cycle-grid">
        ...
        <label>评论巡检窗口（天）<input disabled={!canManage} max={90} min={1} onChange={(event) => setForm({ ...form, review_window_days: Number(event.target.value) || 7 })} type="number" value={form.review_window_days} /></label>
